...
namespace Greenshot.Configuration
{
   ...
   public class AppConfig
   {
      ...
      public ScreenshotDestinations Output_Destinations = ScreenshotDestinations.espUrl;
         ...
         if (startupIni || normalIni)
         {
            ...
            if (appConfig != null)
            {
               ...
               try
               {
                  ...
                  if ((appConfig.Output_Destinations & ScreenshotDestinations.espUrl) == ScreenshotDestinations.espUrl)
                  {
                     coreConfiguration.OutputDestinations.Add(Destination.espUrl);
                  }
                  IniConfig.Save();
               }
               catch (Exception e)
