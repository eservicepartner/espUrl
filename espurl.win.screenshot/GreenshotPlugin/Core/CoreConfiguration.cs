...
namespace GreenshotPlugin.Core
{
   ...
   {
      Editor, FileDefault, FileWithDialog, Clipboard, Printer, EMail, espUrl
   }
   ...
   public class CoreConfiguration : IniSection
   {
      ...
      [IniProperty("Destinations", Separator = ",", Description = "Which destinations? Options are: Editor, FileDefault, FileWithDialog, Clipboard, Printer, EMail, espUrl", DefaultValue = "espUrl")]
