...
namespace Greenshot.Plugin
{
   ...
   /// </summary>
   public enum CaptureMode { None, Region, FullScreen, ActiveWindow, Window, LastRegion, Clipboard, File, IE, Video };

   /// <summary>
   /// The destinations for the capture, these will be set during capture and can be modified by plugins
   /// </summary>
   public enum CaptureDestination { File, FileWithDialog, Clipboard, Printer, Editor, EMail, espUrl };
